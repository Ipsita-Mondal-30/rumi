...
export function Signup() {
  ...
  return (
    <AuthLayout title="Create your account" subtitle="Join Rumi to find compatible flatmates safely and easily.">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link to="/login" className="text-[#4E668A] font-semibold hover:underline">
            Sign in
          </Link>
        </p>
      </form>
